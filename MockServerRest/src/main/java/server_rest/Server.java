            ...
            if (handler != null) {
                try {
                    ...
                    if (body != null && !body.isBlank()) {
                        ...
                        // This pattern does not quite successfully parse the request (in HttpResponse). therefore-
                        // To work with the contents of the request, I use the entire request
                        // A place for your logic
